...
if 'connection' not in st.session_state:
    ...
    def create_df_prioridades_resumido(df):
        ...
        df_prioridades_resumido = df.groupby(['CLIENTE', 'EQUIPAMENTO'])[['FILA', 'SAÍDA']].count().reset_index()
        df_prioridades_resumido.reanem(columns={'FILA':'QTD EM FILA', 'SAÍDA':'QTD FORA DO FILA'})
        try:
